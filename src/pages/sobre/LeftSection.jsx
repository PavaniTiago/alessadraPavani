  ...
  return (
    <div className='h-[27rem] w-[25rem] md:pt-8 xsm:mt-32 md:mt-0'>
        <div className='flex flex-col items-center gap-8 absolute lg:w-[28rem] h-fit z-10'>
            <img src={props.img} alt={props.alt} className='md:w-[15rem] md:h-[15rem] w-[12rem] h-[12rem] rounded-full 3xl:w-[18rem] 3xl:h-[18rem]' />
            <q className='text-gray-100 md:text-xl text-lg text-center px-6'>{props.text}</q>
        </div>
