    ...
    <div className="min-h-screen">
      <div className='flex flex-col justify-center items-center relative'>
        <div className="relative w-full">
          <img className='w-full h-screen object-cover brightness-50 blur-sm' src="/src/assets/img9.jpg" alt="foto do studio alessandra pavani" />
      ...
      <div className='flex flex-col justify-center items-center relative'>
        <div className='w-full relative'>
          <img className='w-full h-[55rem] object-cover object-top brightness-50 blur-sm' src="/src/assets/img11.jpg" alt="foto do studio alessandra pavani" />
        </div>
        <div className='absolute flex flex-col justify-center items-center'>
          <div className='flex flex-col max-w-5xl'>
            ...
            <p className="text-3xl font-bold mt-6 text-yellow-300 leading-tight xsm:px-4 text-center">
      ...
      <div className='bg-slate-200 w-full flex flex-col items-center justify-center'>
        <div className='max-w-4xl xl:rounded-lg py-14'>
          <div className='flex flex-row items-center mx-auto w-[60rem] space-x-12'>
            <img className='w-64 h-64' src="/src/assets/Selo de Garantia de 7 Dias PNG Transparente Sem Fundo.png" alt="" />
