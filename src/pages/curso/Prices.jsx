    ...
    return (
        <div className='flex flex-col items-center justify-center gap-3 px-2 max-w-xl text-neutral-100'>
            ...
            <div className='flex flex-col justify-center items-center gap-1'>
                <h2 className='text-2xl md:text-3xl uppercase font-bold px-8 md:px-12 text-center mt-2'>Hoje você terá a <span className='text-orange-300'>OPORTUNIDADE</span> de adquirir o curso completo de <del className='text-orange-300'>3350,00</del> POR:</h2>
