...
export const Header = () => {
  ...
  return (
    <header className='flex w-screen h-screen bg-neutral-900 font-roboto justify-center md:justify-start' >  
            <img className='w-full brightness-50 blur-sm mt-1 hidden md:block' src="/src/assets/bgImg.jpg" alt='foto do studio alessandra pavani'/>
            <img className='w-full brightness-50 blur-sm mt-1 block md:hidden' src="/src/assets/frontImg.jpg" alt='foto do studio alessandra pavani'/>
