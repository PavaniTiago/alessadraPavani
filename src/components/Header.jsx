...
export const Header = () => {
  return (
    <header className='flex w-full h-full bg-neutral-900 relative font-roboto'>  
            <img className='w-full brightness-50 blur-sm mt-1 ' src="/src/assets/bgImg.jpg" />
            <div className='text-white absolute flex flex-col items-center h-[28rem] w-[40rem] justify-center ml-48 mt-[10rem]'>
              <h2 className='text-7xl mb-8 font-inter'>Studio Alessandra Pavani</h2>    
              ...
              transition ease-in-out hover:-translate-y-1 hover:scale-x-105 duration-200 hover:bg-zinc-900'
              to='/studio'
              >Saiba mais</Link>
            </div>
    </header>
